"use client";
import { useCodeEditorStore } from "@/app/store/useCodeEditor";
import { useEffect, useRef, useState } from "react";
import { LANGUAGE_CONFIG } from "@/app/lib/utils";
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      >
        ...
        <div className="size-6 rounded-md bg-gray-800/50 p-0.5 group-hover:scale-100 transition-transform">
          <Image
